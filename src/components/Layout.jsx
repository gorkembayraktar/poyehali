...
function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen relative bg-slate-50 dark:bg-[#121212] transition-colors duration-500">
      ...
      <div className={`${!isLessonPage ? 'md:ml-64' : ''} min-h-screen`}>
        <div className={`mx-auto flex justify-center items-start min-h-screen ${!isLessonPage ? 'max-w-5xl' : ''}`}>

          {/* Center Column - Content */}
          <div className={`flex-1 w-full relative z-10 min-h-screen ${!isLessonPage ? 'max-w-2xl border-r border-slate-200 dark:border-white/5 md:border-none pb-24 md:pb-0' : ''}`}>
            ...
            <div className={!isLessonPage ? "py-8 md:py-12 px-4" : ""}>
